...
The `dbt-cockroachdb` package contains all of the code required to make dbt operate on a Cockroachdb database. For
more information on using dbt with Cockroachdb, consult [the docs](https://docs.getdbt.com/docs/profile-Cockroachdb).
